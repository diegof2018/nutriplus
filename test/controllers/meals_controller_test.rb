...
class MealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meal" do
    assert_difference('Meal.count') do
      post meals_url, params: { meal: { type_meal_id: @meal.type_meal_id, values: @meal.values } }
    end
  ...
  test "should update meal" do
    patch meal_url(@meal), params: { meal: { type_meal_id: @meal.type_meal_id, values: @meal.values } }
